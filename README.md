...
REST-Api приложение для учета и фиксации сбоев в управляющей
компании инвестиционных фондов, включая менеджер задач и модуль учета
и управления рисками* (*в разработке).

Приложение позволяет фиксировать и управлять инцидентами в бизнес-процессах организации,
в соответствии с требованиями Банка России по обеспечению операционной надежности.

Реализован функционал для мониторинга доступности сервисов компании, включающий автоматическую периодическую проверку
состояния сервисов с настраиваемым интервалом. Система автоматически фиксирует время доступности и простоев, позволяя
оперативно регистрировать и сохранять информацию о сбоях.

Дополнительно предусмотрена возможность управления рисками: пользователи могут вносить данные о потенциальных угрозах
и уязвимостях. Система обеспечивает сбор и анализ ключевых метрик производительности, предоставляя аналитические отчёты
и визуализации для принятия решений. Интегрированный пользовательский интерфейс позволяет легко добавлять
и редактировать информацию о рисках, а также настраивать уведомления о критических изменениях.

Все это способствует проактивному выявлению и устранению проблем, снижению времени простоя сервисов и повышению
общей надёжности IT-инфраструктуры компании. Система также поддерживает экспорт данных для дальнейшего анализа и интеграцию с существующими системами мониторинга и логирования.
...
- Удовлетворение требований Положения Банка России N 779-П;
- Доступ по локальной сети Организации и закрытый по умолчанию доступа из вне;
...
<details>
  <summary><h3>Принципы чистой архитектуры</h3></summary> 
    ...
    Приложение строится на принципах чистой архитектуры и включает в себя 3 слоя: 
...
<details>
   ...
   ```shell
      ...
      - Деактивировать: exit
      - Посмотреть зависимости: poetry show -l
      - Анализ зависимостей: poetry show -t
      - ТЕСТ возможности обновления: poetry update <пакет> --dry-run
